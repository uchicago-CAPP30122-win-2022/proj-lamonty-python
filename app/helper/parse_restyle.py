import re
#sample = {'dimensions[1].constraintrange': [[0.6248482204515293, 0.786903328351732]]}
#sample2 = {'dimensions[2].constraintrange': [[[67574.85492934738, 69844.9430051734], [70633.16811502521, 72178.08933033475]]]}
...
def parse_restyle(input):
    ...
    '''
    index = [re.findall('[0-9]+', k) for k in sample.keys()]
    range_pairs = []
